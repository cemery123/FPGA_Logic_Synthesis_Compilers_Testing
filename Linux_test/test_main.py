        ...
        try:
            ...
            with open(tb_file, 'r') as file:
                ...
                if index != -1:
                    ...
                    print("Not found timescale")
            yosys_sh.dir_maker(dirname) # dirname:/doc/ljx/resamplesource/2024-04-23-03-25-27/Verilog_hdlsrc/sampleModel17995_sub
...
def cp_orgfile(directory_path):
    ...
    for file in files:
        try:
            dirname = path + '/' + file
            V_file = dirname + '/Subsystem.v' # 获取每一个hdlcoder文件的执行文件
