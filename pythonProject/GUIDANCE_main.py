...
folder_path = 'D:\ljx\code\GUIDANCE-master\slsf_randgen\slsf'# your slsf adress
#add_path_cmd = 'addpath(genpath('+folder_path+')'
#add_folders_to_path(eng, folder_path)
eng.addpath('D:\ljx\code\GUIDANCE-master\slsf_randgen\slsf')
eng.cd('D:\ljx\code\GUIDANCE-master\slsf_randgen\slsf')
eng.run('addpath_GUIDANCE.m', nargout=0)
eng.run('Hdl_generation.m', nargout=0)

Save_name = eng.workspace['stmp'] # get stmp from matlab '2024-04-18-10-21-46'
print(Save_name)
...
cmd = 'cp -r /home/user/Verilog_hdlsrc /doc/ljx/resamplesource/'+Save_name+'/Verilog_hdlsrc'
stdin, stdout, stderr = ssh.exec_command(cmd)
